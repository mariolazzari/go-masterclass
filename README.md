...
func main() {
	...
	defer func() {
		...
		if err := db.Close(); err != nil {
			log.Fatalf("Error connectiong database: %v", err)
		}
	}()
...
func main() {
	...
	ctx := context.Background()
	_, err = createUserWithCtx(ctx, db, "Mario Lazzari", "mario.lazzari@gmail.com", "test09120")
	if err != nil {
		log.Fatal(err)
	}
}
...
[Github](https://github.com/joefazee/learning-go-hnews)
